...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_succcedsOnHTTPURLResponseWithData() {
        let data = anyData()
    ...
    func test_getFromURL_succcedsWithEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
    ...
    private func resultValues(data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> (data: Data, response: HTTPURLResponse)? {
        let result = resultFor(data: data, response: response, error: error, file: file, line: line)
        switch result {
        case .sucess(let data, let hTTPURLResponse):
    ...
    private class URLProtocolStub: URLProtocol { // URLProtocol is a classs
