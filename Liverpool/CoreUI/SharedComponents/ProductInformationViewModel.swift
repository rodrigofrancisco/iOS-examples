...
extension ProductInformationView {
    public struct Dependencies {
        ...
        public init(viewModel: ProductInformationViewModel = .fake, appereance: AppearanceModel = AppearanceModel()) {
...
public struct ProductInformationViewModel {
    ...
    private let productDescriptors: [String: String]
    
    public static let fake = ProductInformationViewModel(productTitle: "Abrigo Gianfranco Dunna con bolsillos para hombre", 
